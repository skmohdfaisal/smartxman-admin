...
export default function NewProduct() {
  ...
  useEffect(() => {
    async function fetchAndSeedCategories() {
      ...
      // If we couldn't fetch anything from DB, fall back to core static categories list so the dropdown is NEVER empty or stuck loading!
      if (dbFetchedCats.length === 0) {
        console.warn("Falling back to static core categories list...");
        dbFetchedCats = coreCategories;
      }
          ...
          {step === 2 && (
            <div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200/85 dark:border-slate-800 shadow-sm space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-slate-50 dark:bg-slate-800/30 p-5 rounded-2xl border border-slate-200 dark:border-slate-855 grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                  <div className="space-y-1.5">
